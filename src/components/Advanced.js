...
const Advanced = () => {
  return (
    <section className='advanced flex flex-col justify-center pt-16 pb-10 lg:py-20'>
      <ShortenLink />
      <div className="max-width">
        <div className="mt-40 md:-mt-24 mb-16">
        ...
        <div className="cards relative grid grid-cols-1 gap-10 md:gap-5 md:grid-cols-2 lg:grid-cols-3">
          <div className="line"></div>
          <article className="relative bg-white p-4 mb-10 lg:mb-20 rounded">
